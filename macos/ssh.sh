...
generate_key "$SSH_DIR/id_ed25519_personal" ed25519 "$(whoami)@mac-personal" "personal GitHub"
generate_key "$SSH_DIR/id_ed25519_work"     ed25519 "$(whoami)@mac-work"     "work GitHub"
generate_key "$SSH_DIR/id_rsa_azdo"         rsa     "$(whoami)@mac-azdo"     "Azure DevOps"
